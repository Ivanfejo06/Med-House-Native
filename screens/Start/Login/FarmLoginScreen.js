...
const FarmLoginScreen = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const apiUrl = 'https://hopeful-emerging-snapper.ngrok-free.app/farmaceutico/login';
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
        ...
        <View>
          ...
          <SmallButton title="Olvidé mi contraseña" onPress={() => navigation.navigate('FarmForgot')} style={styles.forgotPasswordButton} textStyle={styles.forgotPasswordText} color="#00EDDF" />
        </View>
...
export default FarmLoginScreen;