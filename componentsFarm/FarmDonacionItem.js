...
const FarmDonacionItem = ({ item, navigation, med }) => {
  const handleItemPress = (id) => {
    navigation.navigate('FarmRequest', { id, med }); //Inventar nombre para pantalla de las request de mandar un medicamento
  };
...
export default FarmDonacionItem;